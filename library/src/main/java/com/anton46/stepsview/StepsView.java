...
public class StepsView extends LinearLayout implements StepsViewIndicator.OnDrawListener {
    ...
    public int mProgressColorIndicator = Color.YELLOW;
    ...
    public StepsView setNeedShowNumber(boolean needShowNumber) {
        mStepsViewIndicator.setNeedShowNumber(needShowNumber);
        return this;
    }
    public StepsView setNumberTextSize(float numberTextSize) {
        mStepsViewIndicator.setNumberTextSize(numberTextSize);
        return this;
    }
    public StepsView setmLineHeight(float mLineHeight) {
        mStepsViewIndicator.setmLineHeight(mLineHeight);
        return this;
    }

    public StepsView setmThumbRadius(float mLineHeight) {
        mStepsViewIndicator.setmThumbRadius(mLineHeight);
        return this;
    }

    public StepsView setOuterCircleOffset(float outerCircleOffset) {
        mStepsViewIndicator.setOuterCircleOffset(outerCircleOffset);
        return this;
    }

    public StepsView setCircleSelectColor(int circleSelectColor) {
        mStepsViewIndicator.setCircleSelectColor(circleSelectColor);
        return this;
    }

    public StepsView setCircleDefaultColor(int circleDefaultColor) {
        mStepsViewIndicator.setCircleDefaultColor(circleDefaultColor);
        return this;
    }
    public StepsView setNumberTextDefaultColor(int textDefaultColor) {
        mStepsViewIndicator.setTextDefaultColor(textDefaultColor);
        return this;
    }
    public StepsView setNumberTextSelectColor(int textSelectColor) {
        mStepsViewIndicator.setTextSelectColor(textSelectColor);
        return this;
    }
