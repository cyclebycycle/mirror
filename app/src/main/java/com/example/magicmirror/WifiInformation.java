...
import com.example.magicmirror.Protocol.AES;
...
public class WifiInformation {
    ...
    //是否需要加密
    String mark ="";
    public WifiInformation(WifiManager wifiManager, String password, String ssid, String key, String mark) throws Exception {
       ...
       // Data  = new String(info);
        //  Log.e("info:", info.Data + "||");
        /*
       for(int i=0;i<info.length;i++) {
            Log.e("info"+i, info[i] + "");//,info.Data)
        }*/
    }
//获取目标Ap当前加密方式
